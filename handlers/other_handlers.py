...
from database.my_database import user_dict_template, users_db
from filters.my_filters import IsDelBookmarkCallbackData, IsDigitCallbackData
from my_keyboard.book_marks import (create_bookmarks_keyboard,
                                    create_edit_keyboard)
from my_keyboard.pagination_kb import create_pagination_key_board
...
async def process_beginning_command(message: Message):
    ...
    await message.answer(
        text=text,
        reply_markup=create_pagination_key_board(
            'backward',
